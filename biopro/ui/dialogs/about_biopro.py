...
class AboutBioProDialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("About BioPro")
    ...
    def _setup_ui(self):
        ...
        desc_lbl = QLabel(
            ...
            "<p>© 2026 BioPro Contributors<br>Licensed under the MIT License</p>"
        )
        ...
        self.sys_info = (
            f"BioPro: v{AppConfig.CORE_VERSION}\n"
        ...
        repo_btn.clicked.connect(lambda: self._open_url("https://github.com/KalaimaranB/BioPro"))
        wiki_btn.clicked.connect(
            lambda: self._open_url("https://github.com/KalaimaranB/BioPro/wiki")
        )
