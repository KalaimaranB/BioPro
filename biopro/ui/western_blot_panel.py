...
class WesternBlotAnalyzer:
    ...
    def add_manual_band(
        ...
        *,
        ...
        # state.profiles already stores the oriented display_profile (bands=peaks).
        # Re-orienting it would double-flip and put bands back as valleys.
        # corrected = display_profile - baseline is already ≥ 0 with bands as peaks.
