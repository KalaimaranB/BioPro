...
class TutorialOverlay(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None, compact_mode: bool = False) -> None:
        ...
        event_bus.subscribe(KarcyticsEvent.ACADEMY_STEP_CHANGED, self._render_step_cb)
        event_bus.subscribe(KarcyticsEvent.ACADEMY_SUBTASK_COMPLETED, self._on_subtask_cb)
        event_bus.subscribe(KarcyticsEvent.ACADEMY_COURSE_COMPLETED, self._on_course_cb)
    ...
    def _cleanup(self, *args) -> None:  # noqa: ARG002
        ...
        event_bus.unsubscribe(KarcyticsEvent.ACADEMY_STEP_CHANGED, self._render_step_cb)
        event_bus.unsubscribe(KarcyticsEvent.ACADEMY_SUBTASK_COMPLETED, self._on_subtask_cb)
        event_bus.unsubscribe(KarcyticsEvent.ACADEMY_COURSE_COMPLETED, self._on_course_cb)
    ...
    def _prompt_close(self) -> None:
        ...
        from karcytics.shared.ui.alerts import ask_question
    ...
    def show_completion_screen(self, course_id: str, badge_reward: str) -> None:
        ...
        from karcytics.ui.wizards.course_complete_overlay import CourseCompleteOverlay
    ...
    def _update_mask(self) -> None:
        ...
        from karcytics.core.models.tutorial_models import ForcedInteractionStep, InteractionStep
