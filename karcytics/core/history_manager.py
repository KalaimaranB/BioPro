...
class ModuleHistory:
    ...
    def push(self, state: dict) -> None:
        ...
        is_heavy_func = self.heavy_checker if self.heavy_checker else ResourceInspector.is_heavy
        for key, value in state.items():
            if is_heavy_func(value):
        ...
        # This creates a "Shallow-Deep" hybrid that is safe for Karcytics's patterns
    ...
    def serialize(self) -> dict:
        ...
        return {"undo_stack": self.undo_stack, "redo_stack": self.redo_stack}
