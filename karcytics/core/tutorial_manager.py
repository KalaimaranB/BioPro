"""Manages the Karcytics Academy state machine, persistence, and event integration."""
...
class AcademyManager:
    ...
    def __init__(self) -> None:
        ...
        self._wait_event_subscription: tuple | None = None  # (KarcyticsEvent, callback)
    ...
    def start_course(self, course_id: str) -> None:
        ...
        event_bus.emit(KarcyticsEvent.ACADEMY_COURSE_PREPARE_PROJECT, course_id)
    ...
    def complete_subtask(self, subtask_id: str) -> None:
        ...
        event_bus.emit(KarcyticsEvent.ACADEMY_SUBTASK_COMPLETED, subtask_id, remaining)
    ...
    def _subscribe_wait_event(self, step: WaitForEventStep) -> None:
        ...
        try:
            event_type = KarcyticsEvent[step.event_name]
        except KeyError:
    ...
    def complete_course(self) -> None:
        ...
        if self.active_course:
            ...
            event_bus.emit(
                KarcyticsEvent.ACADEMY_COURSE_COMPLETED, course_id, self.active_course.badge_reward
            )
    ...
    def _save_checkpoint(self, course_id: str) -> None:
        ...
        if AtomicJsonFile.save(checkpoint_path, data):
            event_bus.emit(KarcyticsEvent.ACADEMY_CHECKPOINT_SAVED, course_id, str(checkpoint_path))
        else:
    ...
    def _emit_step_changed(self) -> None:
        ...
        event_bus.emit(KarcyticsEvent.ACADEMY_STEP_CHANGED, self.current_step)
