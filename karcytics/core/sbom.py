"""SBOM (Software Bill of Materials) Generator for Karcytics Core & Plugins.
...
class SBOMGenerator:
    """Compiles software supply chain inventory for the Karcytics core and active plugins."""
    ...
    def get_metadata(self) -> dict[str, Any]:
        ...
        try:
            timestamp = importlib.metadata.version("karcytics")
        ...
        return {
            ...
            "tools": [
                {
                    "vendor": "Karcytics Authority",
                    "name": "Karcytics SBOM Generator",
                    "version": "1.1.0",
                }
            ],
            "component": {
    ...
    def to_markdown(self) -> str:
        ...
        md = []
        md.append("# Software Bill of Materials (SBOM) — Karcytics\n")
        ...
        md.append("| :--- | :--- |")
        md.append(
            f"| **Application** | Karcytics Core (v{data['metadata']['component']['version']}) |"
        )
    ...
    def _get_core_version(self) -> str:
        try:
            from karcytics import __version__
